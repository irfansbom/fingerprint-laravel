...
let FingerprintSdkTest = (function () {
    ...
    FingerprintSdkTest.prototype.startCapture = function () {
        ...
        this.sdk.startAcquisition(currentFormat, "").then(function () {
            _instance.acquisitionStarted = true;Ww
...
function serverEnroll(){
    ...
    xhttp.open("POST", "assets/fingerprint/src/core/enroll.php", true);
...
function serverIdentify() {
    ...
    xhttp.open("POST", "assets/fingerprint/src/core/verify.php", true);
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send(payload);
}
