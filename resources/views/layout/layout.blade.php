...
<head>
    ...
    <meta name="description" content="Aplikasi Integrasi">
    <meta name="author" content="Bombom Companies">
    <meta name="keywords"
        content="admin, dashboard, dashboard ui, admin dashboard template, admin panel dashboard, admin panel html, admin panel html template, admin panel template, admin ui templates, administrative templates, best admin dashboard, best admin templates, bootstrap 4 admin template, bootstrap admin dashboard, bootstrap admin panel, html css admin templates, html5 admin template, premium bootstrap templates, responsive admin template, template admin bootstrap 4, themeforest html">
    <link rel="shortcut icon" type="image/x-icon" href="{{ url('assets/images/brand/favicon.ico') }}" />
    <title>Aplikasi Integrasi</title>
    ...
    {{-- <link href="{{ url('assets/css/bootstrap4-toggle.min.css') }}" rel="stylesheet" /> --}}
...
<body class="app sidebar-mini ltr light-mode color-header color-menu icon-overlaysidebar-gone">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="{{ url('/') }}"
                                    id="menu_home"><i class="side-menu__icon fe fe-home"></i><span
                                        class="side-menu__label">Dashboard</span>
                                </a>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="{{ url('absen') }}"
                                    id="menu_absen"><i class="side-menu__icon fe fe-home"></i><span
                                        class="side-menu__label">Absen</span>
                                </a>
                            </li>
                            <li class="sub-category">
                                <h3>Users</h3>
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);"
                                    id="menu_users"><i class="side-menu__icon fe fe-database"></i><span
                                        class="side-menu__label">Users Management</span><i
                                        class="angle fa fa-angle-right"></i></a>
                                <ul class="slide-menu">
                                    <li class="side-menu-label1"><a href="javascript:void(0)">Users Management</a>
                                    </li>
            ...
            <div class="container">
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-md-12 col-sm-12 text-center">
                        Copyright © 2022 <a href="javascript:void(0);">Bombom</a>.
                    </div>
                </div>
            </div>
        </footer>
    ...
    {{-- <script src="{{ url('assets/js/bootstrap4-toggle.min.js') }}"></script> --}}
    <!-- BOOTSTRAP JS -->
    ...
    <script src="{{ url('assets/plugins/input-mask/jquery.maskedinput.js') }}"></script>e
